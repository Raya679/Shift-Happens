...
export default function ContentHome() {
    ...
    return (
        <div style={{ backgroundImage: `url(${bg})`, backgroundSize: "cover", backgroundRepeat: "no-repeat" }} className=' pb-32 pt-32 flex justify-center'>
            <div className='bg-slate-300 w-5/6 '>
                <div className=' main flex'>
                    <div>
                        <div className=' font-serif text-[180px] from-stone-950 ml-36 mt-3'>
                            <p>Mental</p>
                        ...
                        <div className=' mt-12 ml-28 text-zinc-900 text-2xl w-5/6'>
                            Welcome to a community where vulnerability is strength and self-care is a priority
                        </div>
                    </div>

                    <div className='image ml-auto mr-32 mt-8'>
                        <img src="brai.png" alt="gh" className=' mt-6 ml-16' />
                    </div>
